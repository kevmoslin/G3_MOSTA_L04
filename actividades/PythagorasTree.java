...
public class PythagorasTree extends JPanel{ 
    ...
    public static void main(String[] args) {
        ...
        //arbol de 8 niveles
        JFrame ventana2 = new JFrame("Arbol de Pitagoras de 8 niveles");
        PythagorasTree panel2 = new PythagorasTree(8);
        ventana2.add(panel2);
        ventana2.setSize(800,800);
        ventana2.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        ventana2.setVisible(true);

        //arbol de 10 niveles
        JFrame ventana3 = new JFrame("Arbol de Pitagoras de 10 niveles");
        PythagorasTree panel3 = new PythagorasTree(10);
        ventana3.add(panel3);
